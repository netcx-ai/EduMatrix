<?php /*a:2:{s:48:"F:\EduMatrix\backend\view\admin\tools\cache.html";i:1753341575;s:42:"F:\EduMatrix\backend\view\common\base.html";i:1753341575;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                        ...
                        <div class="layui-col-md6">
                            <table class="layui-table">
                                ...
                                <tbody>
                                    <tr>
                                        <td>缓存驱动</td>
                                        <td><?php echo htmlentities((string) $cacheInfo['cache_driver']); ?></td>
                                    </tr>
                                    <tr>
                                        <td>缓存前缀</td>
                                        <td><?php echo htmlentities((string) $cacheInfo['cache_prefix']); ?></td>
                                    </tr>
                                    <tr>
                                        <td>缓存过期时间</td>
                                        <td><?php echo htmlentities((string) $cacheInfo['cache_expire']); ?>秒</td>
                                    </tr>
                                    <tr>
                                        <td>内存使用</td>
                                        <td><?php echo htmlentities((string) (isset($cacheInfo['memory_usage']) && ($cacheInfo['memory_usage'] !== '')?$cacheInfo['memory_usage']:'未知')); ?></td>
                                    </tr>
                                    <tr>
                                        <td>内存峰值</td>
                                        <td><?php echo htmlentities((string) (isset($cacheInfo['memory_peak']) && ($cacheInfo['memory_peak'] !== '')?$cacheInfo['memory_peak']:'未知')); ?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
