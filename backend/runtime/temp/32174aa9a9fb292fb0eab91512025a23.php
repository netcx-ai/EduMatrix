<?php /*a:2:{s:51:"F:\EduMatrix\backend\view\admin\stats\overview.html";i:1753341575;s:42:"F:\EduMatrix\backend\view\common\base.html";i:1753341575;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="layui-row layui-col-space15">
        ...
        <div class="layui-col-md3">
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    ...
                    <p>今日新增：<?php echo htmlentities((string) $stats['today_users']); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="layui-col-md3">
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    ...
                    <p>分类：<?php echo htmlentities((string) $stats['category_count']); ?> | 标签：<?php echo htmlentities((string) $stats['tag_count']); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="layui-col-md3">
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    <h2><?php echo htmlentities((string) $stats['today_visits']); ?></h2>
                    <p>本月：<?php echo htmlentities((string) $stats['month_visits']); ?></p>
                </div>
            </div>
        </div>
    </div>
...
layui.use(['layer'], function(){
    ...
    var userTrendOption = {
        ...
        xAxis: {
            type: 'category',
            data: <?php echo json_encode($chartData['user_trend']); ?>
        },
        yAxis: {
            type: 'value'
        },
    ...
    var articleTrendOption = {
        ...
        xAxis: {
            type: 'category',
            data: <?php echo json_encode($chartData['article_trend']); ?>
        },
        yAxis: {
            type: 'value'
        },
    ...
    var visitTrendOption = {
        ...
        xAxis: {
            type: 'category',
            data: <?php echo json_encode($chartData['visit_trend']); ?>
        },
        yAxis: {
            type: 'value'
        },
